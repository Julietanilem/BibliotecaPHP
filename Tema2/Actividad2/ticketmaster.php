...
<body>
    ...
    <?php
         ...
         $fechaEvento= (isset($_POST["fechaEvento"]) && $_POST["fechaEvento"] != "")? $_POST['fechaEvento'] :  false;
         ...
         $numeroDeBoletos = (isset($_POST["numeroDeBoletos"]) && $_POST["numeroDeBoletos"] != "")? $_POST['numeroDeBoletos'] :  false;
         $artistasArray = [
         ...
         $luagaresArray = [
            ...
            if($lugar && $fechaEvento && $apellido && $nombre && $numeroDeBoletos>"0" )
            {
                echo " <h2 align='center'>Tus boletos :)</h2>";
                    $i = 0;
                    ...
                    if($numeroDeBoletos>15)
                    {
                        ...
                        echo "<p align='center'>Se solicitaron <strong>demasiados </strong> boletos, se imprimieron 15 boletos faltaron $faltantes de los $numeroDeBoletos solicitados.</p>";
                    }
            }
            else{
                
                echo "<h4>Error</h4>Específica:<ul>";
                    if(!$lugar)
                    {
                        echo "<li>Lugar</li>";
                    }
                    ...
                    if(!$numeroDeBoletos || $numeroDeBoletos<=0)
                    {
                        echo "<li>Números de boletos, ¡compra al menos uno!</li>";
                    }
                    echo "</ul>";
            }
